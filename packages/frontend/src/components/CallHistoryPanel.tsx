...
import { BuildHistoryRecord } from "@jarlink/shared";
          ...
          {selectedLog ? (
            <div className="flex flex-col gap-4">
              ...
              <div>
                ...
                <pre className="bg-zinc-950 border border-zinc-855 rounded-xl p-3 text-xs font-mono text-zinc-305 leading-relaxed max-h-36 overflow-auto">

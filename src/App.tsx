      ...
      <div className="flex-1 flex flex-col md:flex-row relative">
        ...
        <div className="w-full md:w-64 border-r border-zinc-800 bg-zinc-950/20 py-5 px-4 flex flex-col gap-5 flex-shrink-0">
          ...
          <AnimatePresence>
            {isCreatingProj && (
              <motion.form
                ...
                className="bg-zinc-900 border border-zinc-800 rounded-xl p-3.5 flex flex-col gap-3"
              >
                <div>
          ...
          <div className="flex flex-col gap-1.5 max-h-56 md:max-h-none overflow-y-auto pr-1">
            {loading ? (
              <span className="text-xs text-zinc-600 font-mono italic flex items-center justify-center py-4">
          ...
          <div className="hidden md:flex flex-col gap-2 p-3.5 mt-auto rounded-xl bg-zinc-900/20 border border-zinc-800 text-[10.5px] text-zinc-500 font-sans leading-relaxed">
            ...
            <div>1. View scanned DTOs inside scanner.</div>
            <div>2. Pasteur custom Java classes code to load methods dynamically.</div>
            <div>3. Fill arguments and trigger virtual invokes.</div>
            <div>4. Sequence step pipelines inside Scenario flows.</div>
          </div>
        </div>
        ...
        <div className="flex-1 flex flex-col min-w-0 bg-zinc-900/10">
          ...
          <div className="border-b border-zinc-800 px-6 py-2 flex items-center justify-between gap-4 font-mono select-none overflow-x-auto">
            ...
            {activeProject && (
              <span className="text-[10.5px] text-zinc-500 hidden lg:inline-block bg-zinc-950 px-2 py-1 rounded border border-zinc-900">
